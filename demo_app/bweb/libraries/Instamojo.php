...
//    public function __construct($api_key , $auth_token=null, $endpoint=null)
    ...
    {
        $this->api_key = (string) config_item('api_key');
        $this-> auth_token= (string) config_item('auth_token');
        if(!is_null(config_item('endpoint'))){
            $this->endpoint = (string) config_item('endpoint');
        }
    }
