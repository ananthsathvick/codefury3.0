<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class DatatablesBuilder {
		...
		{
			return $this->_db->where_in($key, $values, $escape);
		}
...
pageLength: 50,
dom: \"lfBrtip\",
buttons: [{extend: 'excelHtml5',exportOptions: {columns: ':visible'}},{extend: 'pdfHtml5',exportOptions: {columns: ':visible'},orientation : 'landscape',
                pageSize : 'LEGAL'},'colvis'],
                    {$dt_options}
                    ajax: {
                        url: \"" . current_url_with_get() . "\",
						type: \"POST\",
                        data: function (d, dt) {
							d.dt_name = \"{$id}\"
...
//		logConsole('data_table_log',$output['query']);
