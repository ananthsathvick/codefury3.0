...
<script type="text/javascript">google.charts.load("current", {packages: ["corechart"]});
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([['Task', 'Actions'], ['Viewed', <?php echo $tot_download; ?>], ['Download', <?php echo $tot_view; ?>]]);
        var options = {title: 'Candidate Resumes', is3D: true,};
        ...
        <div class="content-area5">
            <div class="dashboard-content">
                <div class="dashboard-header clearfix">
                    <div class="row">
                        <div class="col-sm-12 col-md-6"><h4>Hello ,<?php $usr = $this->session->userdata('company');
                                echo $usr['name']; ?></h4></div>
                        <div class="col-sm-12 col-md-6 text-center"><h4>If you offered to anyone Please
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#informus">CLICK HERE</a> to Inform us
                            </h4>
                        </div>                        <!-- <div class="col-sm-12 col-md-6">                                    <div class="breadcrumb-nav">                                        <ul>                                            <li>                                                <a href="<?php //echo site_url(); ?>">Index</a>                                            </li>                                            <li>                                                <a href="<?php //echo site_url('employer/my_account'); ?>" class="active">Dashboard</a>                                            </li>                                        </ul>                                    </div>                                </div> -->
                    </div>
                </div>                <!-- Modal -->
                <div id="informus" class="modal fade" role="dialog">
                    <div class="modal-dialog">                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header"><h4 class="modal-title text-left">Any Comments</h4>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="ui-item bg-success">
                                    <div class="left"><h4>
                                        ...
                                        <p>to search candidate profiles</p></div>
                ...
                <div class="row" id="tblsd">
                    <div class="col-lg-12">
                        <div class="dashboard-list"><h3>Latest Downloaded & viewed profiles</h3>
                                ...
                                <div class="row">
                                    <div class='col-lg-8 offset-lg-1 picker'>
                                        <div class="row">
											...
											<div class="col-lg-4 col-xl-3 col-md-3 input-group ">
                            ...
                            <div class="dashboard-message dashboard-table-responsive bdr clearfix ">
                                <div class="table-responsive dashboard-table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>                                            <?php $i = 1;
                                        foreach ($resumes as $res) {                                                        $user = $this->Common_model->get_tbl_row('resume',$res->resume_id,'user_id,name,education,added_date,update_on');                                                       ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                ...
                                                <td><?php echo !empty($user) ? format_common_date($user->update_on) : 'Deleted'; ?>                                                </td> <?php if ($res->download == 1) { ?>
                                                    ...
                                                    <td><a href="<?php echo !empty($user->user_id) ? site_url('download-resume?K='.base64_encode($res->resume_id)) : '#'; ?>"><span class="text-success">Downloaded</span></a></td>                                               <?php } else if ($res->view == 1) { ?>
            ...
            <p class="sub-banner-2 text-center">© 2020 <?php echo config_item('company_name'); ?></p></div>
    </div>
</div>
<script>$(function () {
