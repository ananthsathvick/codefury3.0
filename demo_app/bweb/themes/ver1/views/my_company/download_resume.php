<table style="width:900px; padding:0px; margin:0px auto; border-collapse:collapse; border-spacing:0px; background:#f7f7f7; vertical-align:top; font-family: Arial, Helvetica, sans-serif;  font-size:24px; line-height: 16px;">
    <tr>
        <td style="padding: 0px; margin:0px; border:none;">
            <table  style="width:100%; border-collapse:collapse; border-spacing:0px; background-color:#FFFFFF; vertical-align:top; border:none; box-shadow:none;">
                <tr>
					<td colspan="5"  style="padding: 0px; margin:0px; border:none; background-color: #FFFFFF; text-align:center;"><h1 style="font-size:40px; "><?php echo $resume->name; ?></h1></td>
                </tr>
                <tr><td colspan="5" style="height:5px;"></td></tr>
                <tr>
                    <td style="width:300px; padding: 0px 5px; background-color: #FFFFFF; vertical-align: top; font-size:24px; text-align:left;">
                        ...
                        <?php foreach($education as $edu){ if($edu['institute']!=''){ ?>
                        ...
                        --><?php /*} */?>
                        <?php if(!empty($achievements) && $resume->company_exp>=3) { ?>
                ...
                <?php } ?>
                    ...
                    <td style="vertical-align: top; width:550px;">
                        ...
                        <table  style="width:100%; border-collapse:collapse; border-spacing:0px; background-color:#FFFFFF; vertical-align:top; border:none; box-shadow:none;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 0px 5px; vertical-align: top;">  
                                    ...
                                    <p style="margin:0px 0px 5px; font-size:<?php echo $font_size; ?>; line-height: <?php echo $line_height; ?>;">
                                        ...
                                        <strong style="font-size:22px; line-height:28px;"><?php echo $w_exp['company']; ?></strong> | <?php echo date('M Y', strtotime($w_exp['exp_f_date'])); ?> - <?php echo isset($w_exp['exp_t_date']) ? date('M Y', strtotime($w_exp['exp_t_date'])) : 'Present'; ?>
                            ...
                            <?php if(!empty($achievements) && $resume->company_exp<=2) { ?>
    ...
    <tr><td style="text-align:right; font-size:16px; background-color:#FFFFFF; color:#000000;">Powered by Code Headed</td></tr>
    <tr><td style="height: 10px; background-color: #FFFFFF;"></td></tr> 
