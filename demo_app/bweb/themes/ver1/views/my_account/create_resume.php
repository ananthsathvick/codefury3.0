                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="50" class="input-text" name="name" id="name" value="<?php echo set_value('name',$resume['name']); ?>" onkeyup="onkup('v_name',this.value)">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="100" class="input-text" name="email" id="email" ng-pattern="/^([6-9]{1}[0-9]{9}|[^\s@]+@[^\s@]+\.[^\s@]{2,})$/" value="<?php echo set_value('email',$resume['email']); ?>" onkeyup="onkup('v_email',this.value)">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>Objectives (Max 100 Characters)</label>

                                                <input type="text" maxlength="300" class="input-text" name="objectives" id="objectives" value="<?php echo set_value('objectives',$resume['objectives']); ?>" onkeyup="onkup('v_objectives',this.value)">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="70" class="input-text" name="languages" id="languages" value="<?php echo set_value('languages',$resume['languages']); ?>" onkeyup="onkup('v_languages',this.value)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-6">Number of Companies you have worked <sup class="text-danger">*</sup> (Max 5 companies)</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="cp_description" id="cp_description" onkeyup="onkup('v_cp_description',this.value)"><?php echo set_value('cp_description',$resume['cp_description']); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="70" class="input-text" name="work_exp[1][job_title]" id="jt_1" value="<?php echo set_value('work_exp[1][job_title]',isset($resume['work_exp'][1]['job_title']) ? $resume['work_exp'][1]['job_title']:''); ?>" onkeyup="onkup('v_jt_1',this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50" class="input-text" name="work_exp[1][company]" id="cmp_1" value="<?php echo set_value('work_exp[1][company]',isset($resume['work_exp'][1]['company']) ? $resume['work_exp'][1]['company']:''); ?>" onkeyup="onkup('v_cmp_1',this.value)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="work_exp[1][w_description]" id="w_description_1" onkeyup="onkup('v_w_description_1',this.value)"><?php echo set_value('work_exp[1][w_description]',isset($resume['work_exp'][1]['w_description']) ? $resume['work_exp'][1]['w_description']:''); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="70" class="input-text" name="work_exp[2][job_title]" id="jt_2" value="<?php echo set_value('work_exp[2][job_title]',isset($resume['work_exp'][2]['job_title']) ? $resume['work_exp'][2]['job_title']:''); ?>" onkeyup="onkup('v_jt_2',this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50" class="input-text" name="work_exp[2][company]" id="cmp_2" value="<?php echo set_value('work_exp[2][company]',isset($resume['work_exp'][2]['company']) ? $resume['work_exp'][2]['company']:''); ?>" onkeyup="onkup('v_cmp_2',this.value)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="work_exp[2][w_description]" id="w_description_2" onkeyup="onkup('v_w_description_2',this.value)"><?php echo set_value('work_exp[2][w_description]',isset($resume['work_exp'][2]['w_description']) ? $resume['work_exp'][2]['w_description']:''); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="70" class="input-text" name="work_exp[3][job_title]" id="jt_3" value="<?php echo set_value('work_exp[3][job_title]',isset($resume['work_exp'][3]['job_title']) ? $resume['work_exp'][3]['job_title']:''); ?>" onkeyup="onkup('v_jt_3',this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50" class="input-text" name="work_exp[3][company]" id="cmp_3" value="<?php echo set_value('work_exp[3][company]',isset($resume['work_exp'][3]['company']) ? $resume['work_exp'][3]['company']:''); ?>" onkeyup="onkup('v_cmp_3',this.value)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="work_exp[3][w_description]" id="w_description_3" onkeyup="onkup('v_w_description_3',this.value)"><?php echo set_value('work_exp[3][w_description]',isset($resume['work_exp'][3]['w_description']) ? $resume['work_exp'][3]['w_description']:''); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="70" class="input-text" name="work_exp[4][job_title]" id="jt_4" value="<?php echo set_value('work_exp[4][job_title]',isset($resume['work_exp'][4]['job_title']) ? $resume['work_exp'][4]['job_title']:''); ?>" onkeyup="onkup('v_jt_4',this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50" class="input-text" name="work_exp[4][company]" id="cmp_4" value="<?php echo set_value('work_exp[4][company]',isset($resume['work_exp'][4]['company']) ? $resume['work_exp'][4]['company']:''); ?>" onkeyup="onkup('v_cmp_4',this.value)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="work_exp[4][w_description]" id="w_description_4" onkeyup="onkup('v_w_description_4',this.value)"><?php echo set_value('work_exp[4][w_description]',isset($resume['work_exp'][4]['w_description']) ? $resume['work_exp'][4]['w_description']:''); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="70" class="input-text" name="work_exp[5][job_title]" id="jt_5" value="<?php echo set_value('work_exp[5][job_title]',isset($resume['work_exp'][5]['job_title']) ? $resume['work_exp'][5]['job_title']:''); ?>" onkeyup="onkup('v_jt_5',this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="50" class="input-text" name="work_exp[5][company]" id="cmp_5" value="<?php echo set_value('work_exp[5][company]',isset($resume['work_exp'][5]['company']) ? $resume['work_exp'][5]['company']:''); ?>" onkeyup="onkup('v_cmp_5',this.value)">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="input-text" maxlength="250" name="work_exp[5][w_description]" id="w_description_5" onkeyup="onkup('v_w_description_5',this.value)"><?php echo set_value('work_exp[5][w_description]',isset($resume['work_exp'][5]['w_description']) ? $resume['work_exp'][5]['w_description']:''); ?></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-6">Level Of Education <sup class="text-danger">*</sup> (Max 3 Level)</label>
                                                ...
                                                <select class="input-text col-md-4" name="edu_level" id="edu_level" onchange="show_edu_div()">
                                                    ...
                                                    <option value="3" <?php echo ($resume['edu_level']==3) ? 'selected':''; ?>>3</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="input-text" name="education[1][institute]" id="inst_1" value="<?php echo set_value('education[1][institute]',isset($resume['education'][1]['institute']) ? $resume['education'][1]['institute']:''); ?>" onkeyup="onkup('v_inst_1',this.value)">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="input-text" name="education[1][branch]" id="branch_1" value="<?php echo set_value('education[1][branch]',isset($resume['education'][1]['branch']) ? $resume['education'][1]['branch']:''); ?>" onkeyup="onkup('v_branch_1',this.value)">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="input-text" name="education[2][institute]" id="inst_2" value="<?php echo set_value('education[2][institute]',isset($resume['education'][2]['institute']) ? $resume['education'][2]['institute']:''); ?>" onkeyup="onkup('v_inst_2',this.value)">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="input-text" name="education[2][branch]" id="branch_2" value="<?php echo set_value('education[2][branch]',isset($resume['education'][2]['branch']) ? $resume['education'][2]['branch']:''); ?>" onkeyup="onkup('v_branch_2',this.value)">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="input-text" name="skills" id="skills" onkeyup="onkup_skills()"><?php echo set_value('skills',$resume['skills']); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 award_sec">
                                                ...
                                                <div class="form-group add-extra">
                                                    ...
                                                    <input type="text" class="input-text" name="awards[]" id="awar0" value="<?php echo set_value('awards[]',isset($resume['awards'][0]) ? $resume['awards'][0]:''); ?>" onkeyup="pass_awar('0',this.value)">
                                                ...
                                                <?php if(!empty($resume['awards'])) {  for($i=1; $i<$awards_count; $i++){ ?>
                                                    ...
                                                    <div class="form-group add-extra" id="awrdiv<?php echo $i; ?>">
                                                        ...
                                                        <input type="text" class="input-text" name="awards[]" id="awar<?php echo $i; ?>" value="<?php echo set_value('awards[]',isset($resume['awards'][($i)]) ? $resume['awards'][($i)]:''); ?>" onkeyup="pass_awar('<?php echo $i; ?>',this.value)">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 0px; margin:0px; border:none;">
                                            ...
                                            <table  style="width:100%; border-collapse:collapse; border-spacing:0px; background-color:#FFFFFF; vertical-align:top; border:none; box-shadow:none;">
                                                ...
                                                <tr><td colspan="3" style="text-align:center"><span id="v_name" style="margin: 5px 0px 10px; color: <?php echo $resume_clr; ?>; font-size: 1.2rem; font-weight: 600; font-size: 80%; line-height: 90%;"></span></td></tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:30%; padding: 0px 5px; background-color: #FFFFFF; vertical-align: top; font-size:14px; text-align:left;">
                                                        ...
                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">
                                                            ...
                                                            <strong><i class="fa fa-envelope"></i> :</strong> <span id="v_email"></span>

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">

                                                            <strong><i class="fa fa-mobile"></i>  :</strong> <span id="v_phone"></span>

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">

                                                            <strong><i class="fa fa-phone"></i>  :</strong> <span id="v_mobile"></span>

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">

                                                            <!--<strong><i class="fa fa-map-marker"></i>  :</strong> <span id="v_address"></span>,<br> <span id="v_city"></span> – <span id="v_pincode"></span> <br> <span id="v_state"></span>.-->
                                                            <strong><i class="fa fa-map-marker"></i>  :</strong> <span id="v_address"></span>,<br> <span id="v_city"></span><br> <span id="v_state"></span>.

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">

                                                            <strong>Languages :</strong> <span id="v_languages"></span>.
                                                        ...
                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;">
                                                            ...
                                                            <strong>Passport No :</strong> <span id="v_passport_no"></span>.
                                                        ...
                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;" class="edu_div1">

                                                            <strong id="v_degree_1"></strong> <br>

                                                            <strong id="v_branch_1"></strong> <br>

                                                            <span><span id="v_edu_f_date_1"></span> - <span id="v_edu_t_date_1"></span> </span> <br>

                                                            <strong id="v_inst_1"></strong>

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;" class="edu_div2">

                                                            <strong id="v_degree_2"></strong> <br>

                                                            <strong id="v_branch_2"></strong> <br>

                                                            <span><span id="v_edu_f_date_2"></span> - <span id="v_edu_t_date_2"></span> </span> <br>

                                                            <strong id="v_inst_2"></strong>

                                                        </p>

                                                        <p style="margin:0px 0px 10px; font-size: 65%; line-height: 110%;" class="edu_div3">

                                                            <strong id="v_degree_3"></strong> <br>

                                                            <strong id="v_branch_3"></strong> <br>

                                                            <span><span id="v_edu_f_date_3"></span> - <span id="v_edu_t_date_3"></span> </span> <br>

                                                            <strong id="v_inst_3"></strong>
                                                        ...
                                                        <ul style="font-size: 65%; line-height: 110%;" id="apnt_awrd">
                                                            ...
                                                            <li id="viewawr0"><?php echo isset($resume['awards'][0]) ? $resume['awards'][0]:''; ?></li>

                                                            <?php if(!empty($resume['awards'])) {

                                                                for ($i=1; $i<=$awards_count; $i++) { ?>

                                                                    <li id="viewawr<?php echo $i; ?>"><?php echo isset($resume['awards'][$i]) ? $resume['awards'][$i]:''; ?></li>

                                                                <?php } } ?>

                                                        </ul>

                                                        <!--<h4 style="margin: 25px 0px 10px; color: <?php /*echo $resume_clr; */?>; font-size: 1.2rem; font-weight: 600;  font-size: 80%; line-height: 90%;" class="h-color"> Hobbies</h4>

                                        <p style="margin:0px 0px 15px; font-size: 65%; line-height: 110%;" id="v_hobbies"></p>-->
                                                        ...
                                                        <table  style="width:100%; border-collapse:collapse; border-spacing:0px; background-color:#FFFFFF; vertical-align:top; border:none; box-shadow:none;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 0px 5px; vertical-align: top;">
                                                                    ...
                                                                    <p style="margin:0px 0px 15px; font-size: 65%; line-height: 110%;" id="v_objectives"></p>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 0px 5px; vertical-align: top;" id="v_skills">
                                                            ...
                                                            <tr class="company_exp_div">

                                                                <td style="padding: 0px 5px; text-align: left; vertical-align: top;">

                                                                    <h4 style="margin: 15px 0px 10px; color: <?php echo $resume_clr; ?>; font-size: 1.2rem; font-weight: 600;  font-size: 80%; line-height: 90%;" class="h-color">College Project</h4>
                                                            ...
                                                            <tr class="company_exp_div1">
                                                                ...
                                                                <td style="padding: 0px 5px; vertical-align: top;">
                                                                    ...
                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">
                                                                        ...
                                                                        <strong id="v_cmp_1"></strong> |  <span id="v_exp_f_date_1"></span> - Present

                                                                    </p>

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_jt_1"></strong>
                                                            ...
                                                            <tr class="company_exp_div2">

                                                                <td style="padding: 0px 5px; vertical-align: top;">

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_cmp_2"></strong> | <span id="v_exp_f_date_2"></span> - <span id="v_exp_t_date_2"></span>

                                                                    </p>

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_jt_2"></strong>
                                                            ...
                                                            <tr class="company_exp_div3">

                                                                <td style="padding: 0px 5px; vertical-align: top;">

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_cmp_3"></strong> | <span id="v_exp_f_date_3"></span> - <span id="v_exp_t_date_3"></span>

                                                                    </p>

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_jt_3"></strong>
                                                            ...
                                                            <tr class="company_exp_div4">

                                                                <td style="padding: 0px 5px; vertical-align: top;">

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_cmp_4"></strong> | <span id="v_exp_f_date_4"></span> - <span id="v_exp_t_date_4"></span>

                                                                    </p>

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_jt_4"></strong>
                                                            ...
                                                            <tr class="company_exp_div5">

                                                                <td style="padding: 0px 5px; vertical-align: top;">

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_cmp_5"></strong> | <span id="v_exp_f_date_5"></span> - <span id="v_exp_t_date_5"></span>

                                                                    </p>

                                                                    <p style="margin:0px 0px 5px; font-size: 65%; line-height: 110%;">

                                                                        <strong id="v_jt_5"></strong>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 0px 5px; vertical-align: top;">
                                                                    ...
                                                                    <ul style="margin-top: 0px; font-size: 65%; line-height: 110%; padding-left:20px;" id="apnt_ach">
                                                                        ...
                                                                        <li id="viewach0"><?php echo isset($resume['achievements'][0]) ? $resume['achievements'][0]:''; ?></li>

                                                                        <?php if(!empty($resume['achievements'])) {

                                                                            for ($i=1; $i<=$achv_count; $i++) { ?>

                                                                                <li id="viewach<?php echo $i; ?>"><?php echo isset($resume['achievements'][$i]) ? $resume['achievements'][$i]:''; ?></li>
