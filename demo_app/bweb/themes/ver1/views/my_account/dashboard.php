                ...
                <div class="content-area5">
                    <div class="dashboard-content">
                        <div class="dashboard-header clearfix">
                            <div class="row">
                                <div class="col-sm-12 col-md-6"><h4>Hello , <?php $usr = $this->session->userdata('user'); echo $usr['name']; ?></h4></div>
                                ...
                                <h4>Your resume expires on <?php echo date('Y-m-d',strtotime($oneYearOn->expiry_date)); ?></h4>
                                <?php } ?>
                                </div>
                            </div>
                        </div>
