...
<head>
    ...
    <link rel="stylesheet" type="text/css" id="style_sheet" href="<?php echo theme_url(); ?>css/skins/midnight-blue.css">    <!-- Favicon icon -->    <!--<link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon" >-->    <!-- Google fonts -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo theme_url(); ?>css/ie10-viewport-bug-workaround.css">    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->    <!--[if lt IE 9]><script  src="<?php echo theme_url(); ?>js/ie8-responsive-file-warning.js"></script><![endif]-->
    ...
    <script src="<?php echo theme_url(); ?>js/magicscroll/magicscroll.js" type="text/javascript"></script>    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->    <!--[if lt IE 9]>    <script  src="<?php echo theme_url(); ?>js/html5shiv.min.js"></script>    <script  src="<?php echo theme_url(); ?>js/respond.min.js"></script>    <![endif]--> <?php echo config_item('google_analytics'); ?>
</head>
<body>
                    ...
                    if ($company_header) { ?>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="<?php echo site_url('secure/resume_format'); ?>" class="nav-link link-color"><?php echo ($check_res)?'<i class="flaticon-pencil"></i> Edit Resume':'<i class="flaticon-plus"></i> Build Resume'?></a>
                            </li>
                        </ul>                <?php } ?><?php } else { ?>
                    <ul class="navbar-nav ml-auto">
