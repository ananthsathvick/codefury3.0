...
class Employer extends Front_Controller
{
    ...
    public function register($ajax = false)
    {
        ...
        $this->form_validation->set_rules('mobile', 'Alternate Number', 'trim|required|max_length[120]|regex_match[/^[0-9]{10,11}/]',array('regex_match'=>'Alternate number should be numbers with country code eg: 0xxxxxxxxxx, xxxxxxxxxx'));
