                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="sp-logo-wrap text-center pa-0 mb-30">
                                    <a href="<?php echo site_url(); ?>">
                                        <img class="brand-img" src="<?php echo base_url('assets/img/fm-logo.png'); ?>" alt="<?php echo config_item('company_name'); ?>"/>
                                        <span class="brand-text"><img  src="<?php echo base_url('assets/img/fm-logo.png'); ?>" alt="<?php echo config_item('company_name'); ?>"/></span>
                                    </a>
                                </div>
                                <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">Need help with your password?</h3>
                                    <p class="text-center txt-grey nonecase-font">Enter the registered mobile number you use for <?php echo config_item('company_name'); ?>, and we’ll help you create a new password.</p>
                                </div>
                                <?php $h_err = ($this->session->flashdata('error') || form_error('username') || form_error('login_type')) ? 'has-error':''; ?>
                                <div class="form-wrap">
                                    <form action="<?php echo site_url('login/otp_verify'); ?>" method="post">
                                        <div class="form-group">
                                            <label class="control-label mb-10" for="exampleInputEmail_2">Enter OTP</label>
                                            <input type="text" name="otp" class="form-control <?php echo $h_err; ?>"   placeholder="Enter OTP" maxlength="8">
