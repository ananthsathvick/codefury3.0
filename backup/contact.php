...
<head>
 ...
 <!-- Basic -->
  <title>Contact us | Code Headed & Fresher Placement Services</title>
  ...
  <meta name="description" content="Udyog is one of the best one stop leading consultancy services for fresher and experienced candidate in Bangalore. Feel free to contact us our dedicated team of professionals having skills in different industries.">
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li> <a href="campus_selection.php" title="Campus Selection">Campus Selection</a> </li>h
...
<div class="col-md-3"><center><a href="candidate_register.php" ><img src="images/3.gif" ></a></center></div>
          ...
          <div class="col-md-6">
            ...
            <form role="form" id="contactForm" data-toggle="validator" class="shake" method="post" action="">
              <div class="form-group">
                <div class="controls">
                  <input type="text" id="name" placeholder="Name" required data-error="Please enter your name" name="name">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="controls">
                  <input type="email" class="email" id="email" placeholder="Email" required data-error="Please enter your email" name="email">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="controls">
                  <input type="text" id="msg_subject" placeholder="Subject" required data-error="Please enter your message subject" name="subject">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="controls">
                  <textarea id="message" rows="7" placeholder="Message" required data-error="Write your message" name="msg"></textarea>
                  <div class="help-block with-errors"></div>
                </div>  
              </div>

              <button type="submit" id="submit" class="btn-system btn-large" name="submit">Send</button>
...
$to='info@udyogconsultancy.com';
$subject=$_POST['subject'];
$name=$_POST['name'];
$email=$_POST['email'];


$email_recipients ='info@udyogconsultancy.com' ;
$email_subject = "Code Headed";
$enable_auto_response = false;//Make this false if you donot want auto-response.
$email_from =$_POST['email']; /*From address for the emails*/
...
{		
				...
				?> <script>
				 alert("Thankyou .Your mail sent successfully!");
