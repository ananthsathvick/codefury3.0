...
$_SESSION['cemail']=$buyer_email;
$_SESSION['cname']=$buyer_name;

$dt=date('Y-m-d'); 
$renewdate = date("Y-m-d", strtotime(date("Y-m-d", strtotime($dt)) . " + 1 year"));
$qry= "update  candidate set payment_id='$payment_id',status='$status',datasign='$DataSign',payment_date='$dt',renew_date='$renewdate' where email='".$_SESSION['cemail']."'";
...
$to=$_SESSION['cemail'];
  ...
  <h5 style="text-align:center;">
    <span class="style1">Your Payment has been credited.A confirmation mail has been sent to you.Please click on the 'FINISH' button to generate password for your dashboard.Kindly check your registered mail for login credentials.</span></h5><br/>
<form role="form" id="contactForm" data-toggle="validator" class="shake" method="post" action="finish.php" style="text-align:center;"> 
             
              <button type="submit" id="submit" class="btn-system btn-large" name="submit">FINISH</button>
...
$to=$_SESSION['cemail'];
  ...
  <h5 style="text-align:center;">
    <span class="style1">Sorry ,your transaction gets failed.Please try again.</span></h5><br/>
