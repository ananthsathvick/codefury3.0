...
<br/>
            ...
            <div class="col-md-4" style="background: #8080802b;" ><label>Name:</label></div><div class="col-md-8" style="margin-bottom:5px;background: #cee2ce;"> <?php echo $row['cpname'];?></div><br/>
            ...
            <div class="col-md-4" style="background: #8080802b;"><label>Email:</label></div> <div class="col-md-8" style="margin-bottom:5px;background: #cee2ce;"><?php echo $row['email'];?></div><br/>
            <div class="col-md-4" style="background: #8080802b;"><label>Contact Number:</label></div> <div class="col-md-8" style="margin-bottom:5px;background: #cee2ce;"><?php echo $row['cnumber'];?></div><br/><br/>
