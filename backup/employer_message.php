...
$qry= "update employer set email_verification='done' where email='".$_GET['eemail']."'";
$res=$obj->execute($qry);
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12" style="min-height:1000px;">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title" style="border-bottom:none;"><span style="border-bottom:none;"> Dear User,<br/><br/>
           
            Thank you for choosing us.<br/>
            We are setting up an exclusive account for you.<br/>
            A confirmation mail will be sent to you once the account become active.<br/>
            
           
            <br/><br/>Thank you for your cooperation. <br/>
            Team Udyog.</span></h4>
