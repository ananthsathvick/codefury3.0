    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Approved Requests <small></small></h2>
         ...
         $r="select * from employer where admin_verification='done'";
			  ...
			  {?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['cpname'];?></td>
                           <td><?php echo $row['email_verification'];?></td>
                          <td><?php echo $row['admin_verification'];?></td>
                          <td><a href="viewmore.php?vid=<?php echo $row['emp_slno'];?>">View More</a></td>
                        </tr>
                      <?php } ?> 
                      </tbody>
                    </table>
