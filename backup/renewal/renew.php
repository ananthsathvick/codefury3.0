      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12" style="min-height:1000px;">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title" style="border-bottom:none;"><span style="border-bottom:none;">Hi , 
            <br/><br/>Your payment for the account is expired.If you wish to continue with our service please renew your account.<br/>
            Team Udyog.</span></h4>
...
4. The Company reserves the right to change these conditions from time to time as it sees fit and your continued use of the site will signify your acceptance of any adjustment to these terms. User is required to check terms and conditions at every visit. No notification communication will be done subject to change in terms and conditions.
              ...
              <button type="submit" id="submit" class="btn-system btn-large" name="login">Renew Now</button>
