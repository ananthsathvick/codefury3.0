...
<head>
 ...
 <!-- Basic -->
  <title>Candidate Login | Udyog Placement Services | Recruitment Process</title>
  ...
  <meta name="description" content="Code Headed provide easy hiring process for all fresher’s and experienced candidates based upon their qualification and technical skills. Follow Udyog to get updated on current recruitment process.">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-5"  style="min-height:600px;">
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title"><span>Candidate Login</span></h4>
            ...
            <!-- Start Contact Form -->
             ...
             <form role="form" id="contactForm" data-toggle="validator" class="shake" method="post" action="">
              ...
              <a href="fpwdc.php"><em>Forgot Password?</em></a>
...
<div class="col-md-2" style="text-align:center;"> </div>
  ...
  <div class="col-md-5" style="text-align: center;" >
            ...
            <!-- Classic Heading -->
            <h4 class="classic-title" style="text-align: left;"><span>Sign Up</span></h4>

            <!-- Start Contact Form -->
             
             
            <a href="candidate_register.php"><img src="images/3.gif" ></a><br/><br/>
...
if(isset($_POST['login']))
{
 ...
 $r="select * from candidate where email='".$_POST['email']."' && password='".$_POST['password']."'";
		 ...
		 if(mysqli_num_rows($result_qry)==1)
          {
			 ...
			 $_SESSION['ccid']=$row['cid'];
		      ...
		      if($row['renew_date']<$tod)
			  {
			        ?> <script>
				
				   window.location=("renewal/renew.php");
	                </script>
					<?php 
