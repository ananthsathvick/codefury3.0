                    ...
                    <div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-wrap">
                                    <form action="<?php echo site_url('secure/forgot_password'); ?>" method="post">
...
<!--                                            <a class="capitalize-font txt-orange block mb-10 pull-right font-12" href="--><?php //echo site_url('login'); ?><!--">Login</a>-->
                                            <a class="btn btn-primary btn-rounded pull-left" href="<?php echo site_url('secure/login'); ?>">Return to Login</a>
